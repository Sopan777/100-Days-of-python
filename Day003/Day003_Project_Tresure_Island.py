...
if crossroad == "left":
    river = input('You have come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim across.').lower()
    if river == "wait": 
        ...
        if color == "red":
            ...
            print("You chose a door that doesn not exist. Game Over.")
    else:
